...
`docker network create --gateway 127.0.0.1 --subnet 127.0.0.0/16 traffic-light`
...
`docker run -d --name nginx-proxy --network traffic-light -p 3000:3000 -p 4000:4000 -p 5000:5000 -v ~/nginx/conf.d/:/etc/nginx/conf.d/ nginx:1.21`
